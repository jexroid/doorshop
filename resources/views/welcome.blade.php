    ...
    <section class="overflow-x-hidden">
        <div class="flex justify-center my-12 w-full items-center ">
            <div class="w-full text-end px-8 container">
                <h1
                    class="text-3xl mb-8 font-bold tracking-tight text-gray-900 md:text-center sm:text-4xl/snug md:text-7xl/snug lg:text-5xl/loose welcome wsau text-right" @php echo $direction @endphp>
